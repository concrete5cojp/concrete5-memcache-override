...
$classLoader->addPrefix('Application\\Memcached', DIR_APPLICATION . '/' . DIRNAME_CLASSES . '/Concrete/Session');
$classLoader->register();

$app->bind('Concrete\Core\Session\SessionFactoryInterface', 'Application\Memcached\SessionFactory');
